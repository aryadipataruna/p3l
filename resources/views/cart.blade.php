...
<head>
    ...
    <style>
        ...
        /* #checkoutSection .store-shipping-select {
            min-width: 200px;
        } */ /* Dihapus karena pilihan ongkir per toko dihilangkan */
        .modal-overlay {
            position: fixed;
            top: 0;
            left: 0;
...
<body class="bg-gray-100">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-4 py-4 flex flex-col sm:flex-row justify-between items-center">
            <div class="text-2xl font-bold text-green-600 mb-2 sm:mb-0">TokoKita</div>
    ...
    <script>
        ...
        const state = {
            cartItems: [
                ...
                {
                    id: "P003",
                    name: "Charger Mobil Fast Charging 3.0",
                    description: "Dual Port USB, Universal",
                    notes: "",
                    price: 150000,
                    originalPrice: null,
                    quantity: 2,
                    checked: false,
                    store: "GudangGadget",
                    image: "https://placehold.co/100x100/E0E0E0/757575?text=Charger"
                }
            ],
            stores: [
            ...
            addresses: [
                ...
                },
                {
                    id: "ADDR002",
                    label: "Rumah Ortu",
                    recipientName: "Bapak/Ibu Daniel",
                    phone: "081234567890",
                    fullAddress: "Jl. Merdeka No. 10, Gondokusuman, Kota Yogyakarta, D.I. Yogyakarta, 55222",
                    isPinpointed: false,
                    isPrimary: false
                },
                 {
                    id: "ADDR003",
                    label: "Kantor",
                    recipientName: "Daniel (Work)",
                    phone: "0274-555111",
                    fullAddress: "Gedung Cyber Lt. 3, Jl. Ring Road Utara, Condongcatur, Depok, Sleman, D.I. Yogyakarta 55283",
                    isPinpointed: true,
                    isPrimary: false
                }
            ],
            ...
            checkout: {
                // shippingOptionsPerStore: {}, // Tidak digunakan lagi
                totalShippingCost: 0, // Akan dihitung berdasarkan subtotal
        ...
        function renderCheckoutOrderItemsDOM() {
            ...
            // Tidak perlu bindCheckoutShippingEvents() lagi
        }
        ...
        function renderCheckoutSummaryDOM() {
            ...
            // Hitung total ongkos kirim berdasarkan subtotal keseluruhan
            let totalCheckoutShipping = 0;
            if (selectedCartItems.length > 0) {
                totalCheckoutShipping = subtotal < 1500000 ? 100000 : 0;
            }
            state.checkout.totalShippingCost = totalCheckoutShipping; // Simpan ke state jika perlu
            ...
            const pointsRedeemedValue = state.checkout.redeemedPointsAmount * 10000;
            const discount = 0;
        ...
        function handleProceedToCheckout() {
            ...
            state.checkout.totalShippingCost = 0; // Reset total shipping cost
        ...
        // function handleCheckoutShippingChange(storeName, shippingValue) { // Tidak diperlukan lagi
        //     // state.checkout.shippingOptionsPerStore[storeName] = parseFloat(shippingValue);
        //     renderCheckoutSummaryDOM();
        // }
        ...
        function handlePaymentTimeout() {
            ...
            // state.userAvailablePoints += state.checkout.redeemedPointsAmount; // Poin dikembalikan ke saldo
            state.checkout.redeemedPointsAmount = 0;
        ...
        function handleConfirmPaymentProof() {
            ...
            if (isProofValid) {
                ...
                const statusMessage = document.getElementById('paymentStatusMessage');
                if(statusMessage) {
                    statusMessage.textContent = "Bukti pembayaran diterima. Pesanan sedang disiapkan. Notifikasi akan dikirim ke penitip.";
                ...
                renderCartListDOM();
                renderCartSummaryDOM();
                console.log("Status transaksi diubah menjadi 'Disiapkan', notif ke penitip (simulasi).");
        ...
        // function bindCheckoutShippingEvents() { // Tidak diperlukan lagi
            // document.querySelectorAll('.store-shipping-select').forEach(select => {
            //     const newSelect = select.cloneNode(true);
            //     select.parentNode.replaceChild(newSelect, select);

            //     newSelect.addEventListener('change', (e) => {
            //         handleCheckoutShippingChange(e.target.dataset.storeName, e.target.value);
            //     });
            // });
        // }
        ...
        function bindAddressModalEvents() {
            ...
            // Re-bind click events for address selection every time modal is rendered
