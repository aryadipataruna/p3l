...
use App\Models\Penitip; // Import Jabatan model for getPegawaiRole

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Hash;
// Import Auth facade for logout
// Import PersonalAccessToken if needed, though not strictly necessary for this code
