...
<body>
    <div class="container-auth">
        ...
        <div class="auth-right" id="panel-form">
            <!-- LOGIN FORM -->
            <form method="POST" action="<?php echo e(route('login')); ?>" class="form-auth" id="form-login">
                <?php echo csrf_field(); ?>
                ...
                <div class="input-group-auth">
                    <img src="<?php echo e(asset('images/Password.png')); ?>" alt="Password">
            ...
            <form method="POST" action="" class="form-auth hidden" id="form-register">
                ...
                <div class="input-group-auth">
                    <img src="<?php echo e(asset('images/User.png')); ?>" alt="Nama">
                ...
                <div class="input-group-auth">
                    <img src="<?php echo e(asset('images/Cart.png')); ?>" alt="Role">
                ...
                <div class="input-group-auth">
                    <img src="<?php echo e(asset('images/User.png')); ?>" alt="NoTelepon">
                    <input type="text" name="generic_phone" placeholder="Nomor Telepon" required data-generic-name="phone">
                </div>
                <div class="input-group-auth">
                    <img src="<?php echo e(asset('images/HomeBtn.png')); ?>" alt="Alamat">
                ...
                <div class="input-group-auth">
                    <img src="<?php echo e(asset('images/Password.png')); ?>" alt="Confirm">
    ...
    <script>
        ...
        document.getElementById('forgot-role').addEventListener('change', function() {
            ...
            if(['pembeli','penitip','organisasi'].includes(role)) {
                ...
                div.innerHTML = `
                <div class="input-group-auth" style="margin-bottom:16px;">
                    <img src="<?php echo e(asset('images/User.png')); ?>" alt="TanggalLahir">
...
<?php /**PATH D:\p3l\resources\views/loginRegister.blade.php ENDPATH**/ ?>