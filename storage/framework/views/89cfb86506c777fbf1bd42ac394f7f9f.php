...
<body>
    ...
    <div class="navbar">
        <div class="nav-links">
            <a href="#">Dashboard</a>
            <a href="<?php echo e(route('adminPagePegawai')); ?>">Pegawai</a>
            <a href="<?php echo e(route('adminPageOrganisasi')); ?>">Organisasi</a>
            <a href="<?php echo e(route('adminPageMerchandise')); ?>">Merchandise</a>
            <a href="<?php echo e(route('adminPageAlamat')); ?>">Alamat</a>
            <a href="<?php echo e(route('adminPage')); ?>">Merchandise</a>
            <a href="#">Profile</a>
        </div>
        <div class="user-info">
    ...
    <div id="addMerchandiseModal" class="modal">
        <div class="modal-content">
            ...
            <div id="addFormErrorMessages" class="form-error-messages"></div> 
    ...
    <div id="editMerchandiseModal" class="modal">
        <div class="modal-content">
            ...
            <div id="editFormErrorMessages" class="form-error-messages"></div> 
...
<?php /**PATH D:\p3l\resources\views/admin/adminPageMerchandise.blade.php ENDPATH**/ ?>